                ...
                <div className="relative">
                    ...
                    >
                        {projects.map((project, index) => (
                            <SwiperSlide key={project.title} className="!w-[300px] sm:!w-[350px] md:!w-[400px]">
                                <div className="bg-slate-800 rounded-lg overflow-hidden border border-slate-700 hover:border-sky-500/50 transition-all duration-300 group hover:shadow-lg hover:shadow-sky-500/10 h-full flex flex-col">
                                    {/* Project Image/Screenshot */}
                                    <div className="relative h-40 sm:h-48 bg-gradient-to-br from-slate-700 to-slate-800 overflow-hidden shrink-0">
                                        {project.iframeUrl ? (
                                            ...
                                            <div className="relative w-full h-full group-hover:scale-105 transition-transform duration-500">
                                                ...
                                                <a href={project.liveUrl || project.githubUrl} target="_blank" rel="noopener noreferrer" className="absolute inset-0" />
                                            </div>
                                        ) : (
                                    ...
                                    <div className="p-4 sm:p-6 flex flex-col flex-grow">
                                        ...
                                        <p className="text-slate-400 mb-4 leading-relaxed text-sm sm:text-base line-clamp-3">
                                            {project.description}
                                        </p>
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                                            <a
                                                ...
                                                className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-slate-700 text-slate-300 rounded-lg hover:bg-slate-600 hover:text-white transition-all duration-300 text-sm flex-1"
                                            >
                                            ...
                                            {project.liveUrl && (
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-sky-500 text-white rounded-lg hover:bg-sky-600 transition-all duration-300 text-sm flex-1"
                                                >
