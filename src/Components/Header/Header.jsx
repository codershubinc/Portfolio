      ...
      <div className='flex    p-1 rounded-lg bg-[#212121] justify-between'>
        ...
        <div className='flex gap-1 justify-center text-center items-center p-1 '>
          ...
          <NavLink
            to="/"
            className={({ isActive }) =>
              ` flex justify-center text-center items-center  py-2 pr-4 pl-3 duration-200  ${isActive ? "text-red-200" : "text-gray-700"} 
            bg-gray-500 w-20 h-8 hover:shadow-cyan-500/50 rounded-[30px]  cursor-pointer border-2 border-black border-solid border-b  hover:bg-gray-400 lg:hover:bg-transparent lg:border-0 hover:text-orange-700 lg:p-0`
            }
          >
            Home
          </NavLink>
